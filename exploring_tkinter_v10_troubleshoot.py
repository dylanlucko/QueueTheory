...
class GUI:
    ...
    def plot_1(self):
        ...
        if self.queue_metrics:
            queue_lengths = [self.queue_metrics.calculate_queue_length_at_time(t) for t in time_points]

            self.ax.plot(time_points, queue_lengths, label='Queue Length')
    ...
    def plot_2(self):
        ...
        time_points = [t for t in range(100)]  # Define your time points here
        queue_lengths = self.queue_metrics.queue_length_over_time(time_points)

        self.ax.plot(time_points, queue_lengths)
        self.ax.set_title('2_Queue Length over Time')
        self.ax.set_xlabel('Time')
        self.ax.set_ylabel('Queue Length')
        self.ax.grid(True)
    ...
    def plot_3(self):
        ...
        time_points = [t for t in range(100)]  # Define your time points here or use a different range
        utilization_values = self.queue_metrics.calculate_server_utilization_over_time(time_points)
    ...
    def plot_4(self, utilization_values):
        self.ax.clear()
        time_points = [t for t in range(len(utilization_values))]
        self.ax.plot(time_points, utilization_values)
        self.ax.set_title('Server Utilization over Time')
        self.ax.set_xlabel('Time')
        self.ax.set_ylabel('Server Utilization')
        self.ax.grid(True)
        self.canvas.draw()
