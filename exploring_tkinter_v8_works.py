...
class GUI:
    def __init__(self, root):
        ...
        for i, label_text in enumerate(labels):
            ...
            label.grid(row=i, column=0, sticky="w", padx=(5, 10), pady=(5, 10))
        ...
        calculate_button.grid(row=len(labels), columnspan=2, sticky="ew", padx=5, pady=20)
        ...
        # Define the initial plot index and list of plot functions
        self.plot_index = 0
        self.plot_functions = [self.plot_1, self.plot_2, self.plot_3, self.plot_4]

        # Next Button for changing plots
        self.next_button = tk.Button(self.frame, text="Next Graph", command=self.show_next_plot, font=("Arial", 14, "bold"))
        self.next_button.pack(side='right', padx=20, pady=20, anchor='s')  # Adjust padding and position
